...
func (sc *SLClientV9) BackupCollection(ctx context.Context, collection string, backupName string, location string, repository string, incremental bool) (*Response, error) {
	...
	if !incremental {
		backupParams["incremental"] = "false"
	}
...
func (sc *SLClientV9) ListBackup(ctx context.Context, backupName string, collection string, location string, repository string) (*Response, error) {
