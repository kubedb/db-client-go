...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"go.virtual-secrets.dev/operator/apis/virtual-secrets/v1alpha1.Secret":     schema_operator_apis_virtual_secrets_v1alpha1_Secret(ref),
		"go.virtual-secrets.dev/operator/apis/virtual-secrets/v1alpha1.SecretList": schema_operator_apis_virtual_secrets_v1alpha1_SecretList(ref),
...
func schema_operator_apis_virtual_secrets_v1alpha1_Secret(ref common.ReferenceCallback) common.OpenAPIDefinition {
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"metadata": {
						SchemaProps: spec.SchemaProps{
							Description: "Standard object's metadata. More meta: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata",
					...
					"secretSource": {
						SchemaProps: spec.SchemaProps{
							Description: "Name of the SecretSource object",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"type": {
						SchemaProps: spec.SchemaProps{
							Description: "Used to facilitate programmatic handling of secret data. More meta: https://kubernetes.io/docs/concepts/configuration/secret/#secret-types",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_operator_apis_virtual_secrets_v1alpha1_SecretList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"metadata": {
						SchemaProps: spec.SchemaProps{
							Description: "Standard list metadata. More meta: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds",
							Default:     map[string]interface{}{},
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of secret objects. More meta: https://kubernetes.io/docs/concepts/configuration/secret",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("go.virtual-secrets.dev/operator/apis/virtual-secrets/v1alpha1.Secret"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"go.virtual-secrets.dev/operator/apis/virtual-secrets/v1alpha1.Secret", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
