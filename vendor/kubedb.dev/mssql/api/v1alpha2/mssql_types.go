...
import (
	...
	apim "kubedb.dev/apimachinery/apis/kubedb/v1alpha2"
)
...
type MsSQLSpec struct {
	...
	StorageType apim.StorageType `json:"storageType,omitempty"`
	...
	// +optional
	AuthSecret *apim.SecretReference `json:"authSecret,omitempty"`

	// Init is used to initialize database
	// +optional
	Init *apim.InitSpec `json:"init,omitempty"`
	...
	// +optional
	ServiceTemplates []apim.NamedServiceTemplateSpec `json:"serviceTemplates,omitempty"`
	...
	// +optional
	TerminationPolicy apim.TerminationPolicy `json:"terminationPolicy,omitempty"`

	// Coordinator defines attributes of the coordinator container
	// +optional
	Coordinator apim.CoordinatorSpec `json:"coordinator,omitempty"`
...
type MsSQLTopology struct {
	...
	// RemoteReplica implies that the instance will be a MsSQL Read Only Replica
	// It will be used for disaster recovery in case of full data-center failure
	// +optional
...
type MsSQLAvailabilityGroupSpec struct {
	...
	// TODO: make it array
	AvailabilityDatabase string `json:"database"`
}
...
type MsSQLStatus struct {
	...
	// +optional
	Phase apim.DatabasePhase `json:"phase,omitempty"`
