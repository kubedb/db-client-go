...
func (r Segments) Do(ctx context.Context) (*http.Response, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("an error happened during the Segments query execution: %w", err)
	}
...
func (r *Segments) ExpandWildcards(value string) *Segments {
