...
func (r ShardStores) Do(ctx context.Context) (*http.Response, error) {
...
func (r *ShardStores) ExpandWildcards(value string) *ShardStores {
...
// API name: status
func (r *ShardStores) Status(value string) *ShardStores {
	r.values.Set("status", value)
