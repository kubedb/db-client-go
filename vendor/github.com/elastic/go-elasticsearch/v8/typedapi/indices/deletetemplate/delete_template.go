...
func (r DeleteTemplate) Do(ctx context.Context) (*http.Response, error) {
...
func (r *DeleteTemplate) MasterTimeout(value string) *DeleteTemplate {
...
// API name: timeout
func (r *DeleteTemplate) Timeout(value string) *DeleteTemplate {
