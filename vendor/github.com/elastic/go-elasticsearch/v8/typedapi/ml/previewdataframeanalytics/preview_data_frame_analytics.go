...
func (r *PreviewDataFrameAnalytics) Raw(raw json.RawMessage) *PreviewDataFrameAnalytics {
	r.raw = raw
...
func (r PreviewDataFrameAnalytics) Do(ctx context.Context) (*http.Response, error) {
