...
func (r *ExplainDataFrameAnalytics) Raw(raw json.RawMessage) *ExplainDataFrameAnalytics {
	r.raw = raw
...
func (r ExplainDataFrameAnalytics) Do(ctx context.Context) (*http.Response, error) {
