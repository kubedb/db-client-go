...
// NewPutCalendarJobFunc returns a new instance of PutCalendarJob with the provided transport.
...
func (r PutCalendarJob) Do(ctx context.Context) (*http.Response, error) {
