...
func (r *PutTransform) Raw(raw json.RawMessage) *PutTransform {
	r.raw = raw
...
func (r PutTransform) Do(ctx context.Context) (*http.Response, error) {
...
// API name: timeout
func (r *PutTransform) Timeout(value string) *PutTransform {
