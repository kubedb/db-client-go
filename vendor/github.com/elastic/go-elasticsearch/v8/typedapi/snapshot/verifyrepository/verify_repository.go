...
func (r VerifyRepository) Do(ctx context.Context) (*http.Response, error) {
...
func (r *VerifyRepository) MasterTimeout(value string) *VerifyRepository {
...
// API name: timeout
func (r *VerifyRepository) Timeout(value string) *VerifyRepository {
