...
func (r UpdateByQueryRethrottle) Do(ctx context.Context) (*http.Response, error) {
...
func (r *UpdateByQueryRethrottle) RequestsPerSecond(value string) *UpdateByQueryRethrottle {
