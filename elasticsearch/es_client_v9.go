...
var _ ESClient = &ESClientV9{}

type ESClientV9 struct {
	client *esv9.Client
}

func (es *ESClientV9) ClusterHealthInfo() (map[string]interface{}, error) {
...
func (es *ESClientV9) NodesStats() (map[string]interface{}, error) {
...
func (es *ESClientV9) ShardStats() ([]ShardInfo, error) {
...
func (es *ESClientV9) GetIndicesInfo() ([]interface{}, error) {
...
func (es *ESClientV9) ClusterStatus() (string, error) {
	res, err := es.client.Cluster.Health(
		es.client.Cluster.Health.WithPretty(),
	)
	if err != nil {
...
func (es *ESClientV9) SyncCredentialFromSecret(secret *core.Secret) error {
...
func (es *ESClientV9) GetClusterWriteStatus(ctx context.Context, db *dbapi.Elasticsearch) error {
...
func (es *ESClientV9) GetClusterReadStatus(ctx context.Context, db *dbapi.Elasticsearch) error {
...
func (es *ESClientV9) GetTotalDiskUsage(ctx context.Context) (string, error) {
...
func (es *ESClientV9) GetDBUserRole(ctx context.Context) (error, bool) {
...
func (es *ESClientV9) CreateDBUserRole(ctx context.Context) error {
...
func (es *ESClientV9) IndexExistsOrNot(index string) error {
...
func (es *ESClientV9) CreateIndex(index string) error {
...
func (es *ESClientV9) DeleteIndex(index string) error {
...
func (es *ESClientV9) CountData(index string) (int, error) {
...
func (es *ESClientV9) PutData(index, id string, data map[string]interface{}) error {
...
func (es *ESClientV9) CheckVersion() (string, error) {
...
func (es *ESClientV9) DisableShardAllocation() error {
	var b strings.Builder
...
func (es *ESClientV9) ReEnableShardAllocation() error {
	var b strings.Builder
...
func (es *ESClientV9) GetClusterStatus() (string, error) {
	res, err := es.client.Cluster.Health(
		es.client.Cluster.Health.WithPretty(),
	)
	if err != nil {
...
func (es *ESClientV9) CountIndex() (int, error) {
...
func (es *ESClientV9) GetData(_index, _type, _id string) (map[string]interface{}, error) {
...
func (es *ESClientV9) CountNodes() (int64, error) {
...
func (es *ESClientV9) AddVotingConfigExclusions(nodes []string) error {
	nodeNames := strings.Join(nodes, ",")
	req := esapi.ClusterPostVotingConfigExclusionsRequest{
		NodeNames: nodeNames,
	}
...
func (es *ESClientV9) DeleteVotingConfigExclusions() error {
...
func (es *ESClientV9) ExcludeNodeAllocation(nodes []string) error {
...
func (es *ESClientV9) DeleteNodeAllocationExclusion() error {
	var b strings.Builder
...
func (es *ESClientV9) GetUsedDataNodes() ([]string, error) {
	req := esapi.CatShardsRequest{
		Pretty: true,
		Human:  true,
		Format: "json",
...
func (es *ESClientV9) AssignedShardsSize(node string) (int64, error) {
	req := esapi.NodesStatsRequest{
		NodeID: []string{node},
		Pretty: true,
		Human:  true,
...
func (es *ESClientV9) EnableUpgradeModeML() error {
	req := esapi.MLSetUpgradeModeRequest{
		Enabled: pointer.BoolP(true),
		Pretty:  true,
		Human:   true,
	}
	resp, err := req.Do(context.Background(), es.client)
...
func (es *ESClientV9) DisableUpgradeModeML() error {
	req := esapi.MLSetUpgradeModeRequest{
