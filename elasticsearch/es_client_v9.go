...
func (es *ESClientV9) ClusterHealthInfo() (map[string]any, error) {
...
func (es *ESClientV9) NodesStats() (map[string]any, error) {
...
func (es *ESClientV9) GetIndicesInfo() ([]any, error) {
...
func (es *ESClientV9) PutData(index, id string, data map[string]any) error {
...
func (es *ESClientV9) GetData(_index, _type, _id string) (map[string]any, error) {
