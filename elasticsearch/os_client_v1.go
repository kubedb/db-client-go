...
func (os *OSClientV1) CountData(_index string) (int, error) {
...
func (os *OSClientV1) DeleteIndex(_index string) error {
...
func (os *OSClientV1) PutData(_index, _id string, data map[string]interface{}) error {
