...
type EDClientV9 struct {
	Client *resty.Client
	Config *Config
}

func (h *EDClientV9) GetHealthStatus() (*Health, error) {
...
func (h *EDClientV9) GetStateFromHealthResponse(health *Health) (esapi.DashboardServerState, error) {
...
func (h *EDClientV9) ExportSavedObjects(spaceName string) (*Response, error) {
	req := h.Client.R().
...
func (h *EDClientV9) ImportSavedObjects(spaceName, filepath string) (*Response, error) {
	req := h.Client.R().
		SetDoNotParseResponse(true).
...
func (h *EDClientV9) ListSpaces() ([]Space, error) {
	req := h.Client.R().
		SetDoNotParseResponse(true).
		SetHeaders(jsonHeaderForKibanaAPI)
...
func (h *EDClientV9) CreateSpace(space Space) error {
	req := h.Client.R().
		SetDoNotParseResponse(true).
		SetHeaders(jsonHeaderForKibanaAPI).
		SetBody(space)
